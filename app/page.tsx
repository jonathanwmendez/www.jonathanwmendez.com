...
const HomePage = (props: Props) => {
  return (
    <div className='flex flex-col justify-center items-center h-screen'>
      <h1 className='font-sans text-4xl italic font-bold tracking-wide bg-gradient-to-r from-indigo-500 to-slate-400 inline-block text-transparent bg-clip-text justify-center'>
        Jonathan W. Mendez
      </h1>
      <h2 className='font-sans text-xl italic font-bold tracking-wide pt-4 pb-4 justify-center'>
